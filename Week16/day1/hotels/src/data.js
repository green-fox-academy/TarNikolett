...
const data = {
    filters: {
        'Star rating': [
            { name: '1 star', checked: false, id: 0 },
            { name: '2 stars', checked: false, id: 1 },
            { name: '3 stars', checked: false, id: 2 },
            { name: '4 stars', checked: false, id: 3 },
            { name: '5 stars', checked: true, id: 4 },
        ],
        'Property type': [
            { name: 'Apartments', checked: false, id: 5 },
            { name: 'Hotels', checked: false, id: 6 },
            { name: 'Hostels', checked: false, id: 7 },
        ],
    },
    hotels: [
        {
